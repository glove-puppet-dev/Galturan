# UI-матрица Galturan LLC

Матрица фиксирует фактическую UI-систему текущей версии проекта Galturan LLC.
...
| --- | --- | --- |
| Home | Объяснить позиционирование Galturan LLC как full-cycle market-entry platform для Туркменистана. | `Become a Partner` |
